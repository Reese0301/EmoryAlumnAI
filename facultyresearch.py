...
LANGFLOW_URL = "http://127.0.0.1:7860/api/v1/run/df7143b1-aac0-44f3-ba0e-4b55ab72df83"


# --- Welcome Message ---
WELCOME_MESSAGE = "Hi there! I am here to help you with Faculty Research reports. Simply paste in what you have, no need to format anything --- I will draft a research report using my writing samples."
...
# --- Main Page Title ---
st.title("AlumnAI: Faculty Research Report Generator")
st.markdown(
    """
    ---
    - 🤖 I am a Chatbot designed to help you write **Research Reports** using available information.
    - 🧾 Simply paste in research summaries or faculty communications — I'll do the rest!
...
with st.sidebar:
    ...
    st.markdown(
        "- Step 1: Gather emails, research updates and other relevant information\n"
        "- Step 2: Copy & Paste everything into the chatbox\n"
        "- Step 3: Proof read AI output and revise"
    )
    ...
    st.markdown(
        ...
        [data-testid="stSidebar"] {
            background-image: url(https://github.com/Reese0301/alumai/blob/main/EmoryResearchSidebar.jpg?raw=true);
